...
<!--                                    --><!-- -->
            ...
            <li>
                <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Edit journal Information</span></a>
            </li>
            <li>
                <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Call for papers</span></a>
            </li>
            <li>
