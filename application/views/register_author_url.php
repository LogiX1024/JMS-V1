...
<body>
    <div class="row">
        ...
        <div class="col-lg-8"><div class="wrapper wrapper-content animated fadeInRight">
            
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5>Register Reviewer</h5><br><br>
                             <br><br>
                        ...
                        <div class="ibox-content">
                            ...
                            <form id="form" action="<?= base_url('/index.php/users/reviewerRegistation') ?>" class="wizard-big" method="post">
                                <h1>Personal Info</h1>
                                <fieldset>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input id="name" name="role" type="hidden" placeholder="Enter Role" value="Author" class="form-control ">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sec_question" placeholder="Enter security question" class="form-control" />
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" name="password2" placeholder="Re-Enter password" class="form-control" id="confirm"/>
                                            </div>
                                            <div class="form-group">
                                                <label>Answer</label>
                                                <input type="text" name="sec_answer" placeholder="Enter Answer" class="form-control" />
                                            </div>
                                        </div>
                                            </div>
                                    </div>
