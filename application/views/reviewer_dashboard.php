            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.title_acceptable == "1") {
                        $('#title_acc').text("Accepted");
                    }
                    if (data.title_acceptable == "2") {
                        $('#title_acc').text("Not Accepted");
                    }
                    $('#title_suggession').text(data.title_suggession);

                    if (data.introduction == "1") {
                        $('#introduction').text("Adequate and Relevant");
                    }
                    if (data.introduction == "2") {
                        $('#introduction').text("Inadequate and/or irrelevant");
                    }
                    $('#introduction_suggession').text(data.introduction_suggession);

                    if (data.originality == "1") {
                        $('#originality').text("Excellent");
                    }
                    if (data.originality == "2") {
                        $('#originality').text("Good");
                    }
                    if (data.originality == "3") {
                        $('#originality').text("Fair");
                    }
                    if (data.originality == "4") {
                        $('#originality').text("Poor");
                    }

                    if (data.clarity == "1") {
                        $('#clarity').text("Excellent");
                    }
                    if (data.clarity == "2") {
                        $('#clarity').text("Good");
                    }
                    ...
                    if (data.completeness == "1") {
                        $('#completeness').text("Excellent");
                    }
                    if (data.completeness == "2") {
                        $('#completeness').text("Good");
                    }
                    if (data.completeness == "3") {
                        $('#completeness').text("Fair");
                    }
                    if (data.completeness == "4") {
                        $('#completeness').text("Poor");
                    }
                    ...
                    if (data.importance == "1") {
                        $('#importance ').text("Excellent");
                    }
                    if (data.importance == "2") {
                        $('#importance ').text("Good");
                    }
                    if (data.importance == "3") {
                        $('#importance ').text("Fair");
                    }
                    if (data.importance == "4") {
                        $('#importance ').text("Poor");
                    }

                    if (data.materials_and_methods == "1") {
                        $('#materials_and_methods ').text(" Acceptable");
                    }
                    if (data.materials_and_methods == "2") {
                        $('#materials_and_methods ').text("Need Modification");
                    }
                    $('#materials_and_methods_suggession').text(data.materials_and_methods_suggession);
                    if (data.results_and_discussion == "1") {
                        $('#results_and_discussion ').text(" Acceptable");
                    }
                    if (data.results_and_discussion == "2") {
                        $('#results_and_discussion ').text("Need Modification");
                    }
                    ...
                    if (data.decision == "2") {
                        $('#decision ').text("Accept with Miner Corrections");
                    }
                    if (data.decision == "3") {
