                ...
                <div class="ibox ibox-content">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <div class="radio i-checks"><label> <input type="radio" checked="" value="1" name="title"> <i></i> Acceptable </label></div>
                            ...
                            <div class="col-sm-9">
                                <div class="radio i-checks"><label> <input type="radio" checked="" value="1" name="intro"> <i></i> Adequate and Relevant </label></div>
                            ...
                            <div class="col-sm-9">
                                <div class="radio i-checks"><label> <input type="radio" checked="" value="1" name="materials"> <i></i> Acceptable </label></div>
                            ...
                            <div class="col-sm-9">
                                <div class="radio i-checks"><label> <input type="radio" checked="" value="1" name="result"> <i></i> Acceptable </label></div>
