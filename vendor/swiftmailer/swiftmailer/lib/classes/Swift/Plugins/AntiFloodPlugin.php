...
{
    /**
     * The number of email to send before restarting Transport.
     *
     * @var int
     */
    private $_threshold;
    ...
    /**
     * Set the number of email to send before restarting.
     *
     * @param int $threshold
     */
    ...
    /**
     * Get the number of email to send before restarting.
     *
     * @return int
     */
